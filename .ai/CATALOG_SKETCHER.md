...
| 12 | CmdSketcherCreateEllipseBy3Points | Ellipse From 3 Points | `addEllipse3Point(p1,p2,p3,construction=false)` | Draw.Conic | **DONE** | shortcut `G, 3, E`; p1/p2=major axis ends, p3=rim point; test: test_drawing_ellipse3point.cpp |
| 13 | CmdSketcherCreateRectangle | Rectangle | `addRectangle(x1,y1,x2,y2,construction=false)` | Draw.Rect | **DONE** | shortcut `G, R`; 4 lines + 4 coincident + 2 H + 2 V constraints per DrawSketchHandlerRectangle Diagonal mode; test: test_drawing_rectangle.cpp |
...
**Phase 1 total: 13/161 tools DONE**
