...
PyMethodDef GeometryFacadePy::Methods[] = {
    {"testGeometryMode",
        ...
        METH_VARARGS,
        "testGeometryMode($self)\n"
        "--\n"
        "\n"
        "testGeometryMode() -> bool\n"
        "\n"
    ...
    {"setGeometryMode",
        ...
        METH_VARARGS,
        "setGeometryMode($self)\n"
        "--\n"
        "\n"
        "setGeometryMode() -> None\n"
        "\n"
    ...
    {"rotate",
        ...
        METH_VARARGS,
        "rotate($self, Ang, axis, /)\n"
        "--\n"
        "\n"
        "rotate(Ang: float, axis: Axis, /) -> None\n"
        "\n"
    ...
    {"scale",
        ...
        "--\n"
        "\n"
        "scale(center: CoordinateSystem, factor: float, /) -> None\n"
        "\n"
    ...
    {"transform",
        ...
        "--\n"
        "\n"
        "transform(transformation: Placement, /) -> None\n"
        "\n"
    ...
    {"hasExtensionOfType",
        ...
        METH_VARARGS,
        "hasExtensionOfType($self, type_str, /)\n"
        "--\n"
        "\n"
        "hasExtensionOfType(type_str: str, /) -> bool\n"
        "\n"
    ...
    {"getExtensionOfType",
        ...
        METH_VARARGS,
        "getExtensionOfType($self, type_str, /)\n"
        "--\n"
        "\n"
        "getExtensionOfType(type_str: str, /) -> DocumentObjectExtension\n"
        "\n"
    ...
    {"getExtensionOfName",
        ...
        "--\n"
        "\n"
        "getExtensionOfName(name: str, /) -> DocumentObjectExtension\n"
        "\n"
    ...
    {"setExtension",
        ...
        "--\n"
        "\n"
        "setExtension(extension: DocumentObjectExtension, /) -> None\n"
        "\n"
    ...
    {"deleteExtensionOfType",
        ...
        METH_VARARGS,
        "deleteExtensionOfType($self, type_str, /)\n"
        "--\n"
        "\n"
        "deleteExtensionOfType(type_str: str, /) -> None\n"
        "\n"
    ...
    {"getExtensions",
        ...
        "--\n"
        "\n"
        "getExtensions() -> List[DocumentObjectExtension]\n"
        "\n"
...
GeometryFacade *GeometryFacadePy::getTwinPtr() const
{
    return getGeometryFacadePtr();
}
